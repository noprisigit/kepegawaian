         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="card card-primary">
                  <form id="formUpdateDataPegawai" method="post" enctype="multipart/form-data">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           <div class="col d-flex justify-content-end">
                              <a href="javascript:history.go(-1)" class="btn btn-secondary mr-2"><i class="fas fa-undo-alt mr-2"></i>Batal</a>
                              <button type="submit" class="btn btn-primary pull-right"><i class="fas fa-edit mr-2"></i>Perbaharui</button>
                           </div>
                        </div>
                     </div>
                  </form>
