                                                ...
                                                <?php else : ?>
                                                    <div class="btn-group">
                                                        ...
                                                        <span data-toggle="modal" data-target="#modal-edit">
                                                            <button type="button" class="btn btn-info btn-edit-user" data-toggle="tooltip" data-placement="top" title="Edit Account" data-id_user="<?= $item['id']; ?>" data-nama="<?= $item['nama'] ?>" data-email="<?= $item['email'] ?>" data-status_akses="<?= $item['status_access'] ?>" data-status_akun="<?= $item['status_account'] ?>"><i class="fas fa-user-edit"></i></button>
                                                        </span>
                                                        ...
                                                        <a href="<?= base_url('users/delete/') . $item['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus user ini?')" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Account"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                <?php endif ?>
                                            </td>
                                        </tr>
