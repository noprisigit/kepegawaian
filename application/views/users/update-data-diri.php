                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <!-- /.card-header -->
                                <!-- form start -->
                                <?= form_open_multipart('users/update-data-diri'); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="tgl_masuk_pegawai" id="tgl_masuk_pegawai" value="<?= $pegawai['tgl_masuk_pegawai']; ?>">
